...
<?php $__env->startSection('content'); ?>
    <form class="form-signin" method="post" action="<?php echo e(route('login.post')); ?>">
        ...
        <a href="<?php echo e(route('registerCliente')); ?>">Register</a>
        <button class="btn btn-lg btn-primary btn-block mt-3" type="submit">Login</button>
    </form>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Debi daPupu\Desktop\programacao\projeto Plantae\ProjetoDoZero\projeto do zero\resources\views/pages/login.blade.php ENDPATH**/ ?>